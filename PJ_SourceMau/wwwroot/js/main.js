$(function () {
    ...
    //BEGIN LEFT MENU
    var pos = location.pathname.indexOf("/create") * location.pathname.indexOf("/edit") * location.pathname.indexOf("/delete") * location.pathname.indexOf("/detail") * location.pathname.indexOf("/member") * location.pathname.indexOf("/permission") * -1;
    ...
    $('#sidebar a[href="' + link + '"]').parent().addClass("active");
    $('#sidebar a[href="' + link + '"]').parent().parent('ul.nav').parent().children('a').click();
    $('#sidebar a[href="' + link + '"]').parent().parent('ul.nav').parent().parent('ul.nav').parent().children('a').click();
    //END LEFT MENU
